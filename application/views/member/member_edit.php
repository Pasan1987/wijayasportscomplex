        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <!-- content -->
                    <form action="<?php echo base_url('index.php/member/Registration/memberRegprocess') ?>" method="POST">
                        <div class="row">
                            <div class="col-md-2"></div>
                            <div class="col-md-8">
                                <div class="card" style="padding:20px; border-color:#4e73df">
                                    <div class="card-header">
                                        <h4 style="padding-left: 190px;"><strong>MEMBER EDIT</strong></h4>
                                    </div><br>
                                    <div class="row col-md-12">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control  bdr-color" placeholder="MM/DD/YYYY *" id="dateofbirth" value="" Name="dob" />
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" minlength="12" maxlength="12" class="form-control  bdr-color" placeholder="NIC" id="nic" name="nic" value="" />
                                            </div>
                                            <div>
