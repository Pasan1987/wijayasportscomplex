                ...
                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab" style="padding-top: 50px;">
                    ...
                    <div class="row register-form">
                        ...
                        <div class="col-md-6">
                            ...
                            <form action="<?php echo base_url()?>index.php/registration/Registration/registrationFee">
                            <input type="submit" class="btn btn-primary btn-user btn-block"  value="aaaaaaa" >
                            </form>
                        </div>
                    </div>
                </div>
